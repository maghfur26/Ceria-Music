    ...
    <>
      <div className="md:min-h-[1000px] lg:min-h-[600px] min-h-52">
        ...
        <div className="flex items-center justify-center">
          <div className="bg-[#222222] w-[1000px] h-[590px] tablets7portrait:w-[1200px] tablets7portrait:h-[1450px] ipadairportrait:w-[1200px] lg:h-[530px] zflip3portrait:h-[700px] iphone14plus:h-[670px] md:h-[1345px] relative rounded-none lg:rounded-2xl md:rounded-none">
            <div className="absolute -top-8 translate-x-[340px] hidden md:hidden lg:block">
            ...
            <div className="absolute flex lg:flex-row md:flex-col flex-col gap-x-8 left-9 right-10 md:mt-12 mt-5">
              <div className="">
                <img
                  src={Bg}
                  alt=""
                  className="md:w-[800px] lg:w-[430px] md:h-[540px] lg:h-[440px] w-[400px] h-[200px] ipadairportrait:rounded-none zflip3portrait:rounded-xl ipadProPortrait:translate-x-[96px] ipadairportrait:translate-x-[79px] tablets7portrait:translate-x-[78px] md:translate-x-[42px] lg:translate-x-0 rounded-none md:rounded-[30px]"
                />
              </div>
              <div className="bg-white md:w-[800px] lg:w-[630px] md:translate-x-[42px] ipadairportrait:translate-x-[79px] zflip3portrait:mt-6 zflip3portrait:rounded-xl tablets7portrait:h-[720px] ipadProPortrait:translate-x-[96px] tablets7portrait:mt-10 tablets7portrait:translate-x-[78px] ipadairportrait:mt-0 ipadairportrait:rounded-none lg:translate-x-0 md:h-[680px] lg:mt-0 md:mt-7 lg:h-[440px] w-full h-[400px] md:rounded-3xl rounded-none relative">
                <div className="absolute md:top-10 top-5 flex flex-col iphonexr18:left-16 iphone12:left-14 iphone14plus:left-[78px] left-10 md:gap-y-5 gap-y-2">
                ...
                <div className="absolute md:top-[590px] lg:top-[380px] top-[280px] left-7 iphonexr18:left-[53px] iphone12:left-[45px] iphone14plus:left-[66px] md:left-[110px] lg:left-[220px] flex md:w-auto px-4 md:px-0">

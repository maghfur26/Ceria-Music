...
const Auth = () => {
  return (
    ...
    <div className="lg:w-1/2 w-full bg-[#232323] flex items-center justify-center px-8 py-12">
      <form className=" p-6 rounded-lg w-full max-w-sm">
        ...
        <button
          type="submit"
          className="flex items-center justify-center bg-blue-500 hover:bg-blue-600 text-white py-2 px-14 sm:px-14 text-[18px] sm:text-[20px] md:text-[23px] rounded-3xl transition"
        >
          Login
        </button>
      </div>
